module.exports = function (bot) {
  bot.dialog('botHelp', [
    function (session, args, next) {
      ...
      message += "To learn more about careers at Microsoft, say 'Show me careers'.\n\n"
      message += "To learn about Microsoft sessions, workshops and office hours, say 'Show me sessions'.\n\n"
